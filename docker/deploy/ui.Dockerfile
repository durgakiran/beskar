...
ENV NEXT_PUBLIC_PAGE_EVENTS_SSE=$NEXT_PUBLIC_PAGE_EVENTS_SSE
ENV NEXT_PUBLIC_PAGE_EVENTS_TRANSPORT_LOG=$NEXT_PUBLIC_PAGE_EVENTS_TRANSPORT_LOG
ENV NEXT_PUBLIC_EDITOR_PRESENCE=$NEXT_PUBLIC_EDITOR_PRESENCE
