/**
 * ColorPicker - Simple color picker for text and highlight colors
 */
...
export function ColorPicker({ onColorSelect, currentColor, label }: ColorPickerProps) {
    ...
    <div className="color-picker" ref={pickerRef}>
      <button
        ...
        style={{
          ...
          border: currentColor ? `2px solid ${currentColor}` : '2px solid #d1d5db',
        }}
