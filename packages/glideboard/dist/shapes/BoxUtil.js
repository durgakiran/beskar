import { ShapeUtil, T, defineMigrations, STROKE_WIDTHS, STROKE_DASH_ARRAYS, svgFill, resolveColor, } from '@durgakiran/glideline';
import { RectangleGeometry } from './localGeometry';
import { StyleValidators, createTextForeignObject } from './localStyles';
export class BoxUtil extends ShapeUtil {
    getDefaultProps() {
        return {
            w: 120,
            h: 80,
    ...
    toSvg(shape) {
        ...
        if (props.opacity < 1)
            g.setAttribute('opacity', String(props.opacity));
...
BoxUtil.migrations = defineMigrations({
    currentVersion: 2,
    migrators: {
        1: {
            up: record => ({
                ...record,
                props: { cornerRadius: 0, color: 'blue', label: '', ...record['props'] },
            }),
            down: record => record,
        },
        2: {
...
//# sourceMappingURL=BoxUtil.js.map