    ...
    const buttonClassName = cn(
        ...
        variant === "primary" &&
            cn(
                ...
                !disabled && !active && "hover:bg-neutral-800 active:bg-neutral-900 dark:hover:bg-neutral-200 dark:active:bg-neutral-300",
        ...
        variant === "secondary" &&
            cn(
                ...
                !disabled && !active && "hover:bg-neutral-100 active:bg-neutral-200 dark:hover:bg-neutral-900 dark:active:bg-neutral-800",
        ...
        variant === "tertiary" &&
            cn(
                ...
                !disabled && !active && "hover:bg-neutral-100 active:bg-neutral-200 dark:hover:bg-neutral-800 dark:active:bg-neutral-700",
